...
export const dictionary = {
  zh: {
    ...
    heroPositioning: '我构建 AI 原生产品，把设计、系统与人的创造力连接起来。',
    explore: '探索我的宇宙',
    nowTitle: '焦点',
    nowIntro: '把长期相信的事，拆成此刻正在推进的系统。',
    worksTitle: '精选项目',
    worksIntro: '精选我真实做过的产品、工具与 AI 项目。',
    thinkingTitle: '思考与方法',
  ...
  en: {
    ...
    heroBeliefEn: '',
    heroPositioning: 'I build AI-native products where design, systems and human creativity meet.',
    explore: 'Explore My Universe',
    nowTitle: 'Focus',
    nowIntro: 'Turning long-term beliefs into systems moving right now.',
    worksTitle: 'Selected Works',
    worksIntro: 'Selected products, tools and AI projects I have actually built.',
    thinkingTitle: 'Thinking & Approach',
    thinkingIntro: 'Writing to form systems and share evolving cognition.',
    aboutTitle: 'About',
    liveTitle: 'Live Signals',
